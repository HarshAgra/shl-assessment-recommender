...
# # #     return [
# # #         {
# # #             "Assessment Name": data[i]["Assessment Name"],
# # #             "URL": data[i].get("URL", "N/A"),
# # #             "Remote Testing Support": data[i].get("Remote Testing Support", "N/A"),
# # #             "Adaptive/IRT Support": data[i].get("Adaptive/IRT Support", "N/A"),
# # #             "Duration": data[i].get("Duration", "N/A"),
# # #             "Test Type": data[i].get("Test Type", "N/A"),
# # #         }
...
# # # Get top N similar assessments with duration filter
# # def get_top_n(query, n=10):
# #     duration_limit = extract_duration(query)
    
# #     # Filter data if time constraint is present
# #     filtered_data = [
...
# #     # Recompute embeddings for filtered data
...
# #         url = item.get('URL', '#')
# #         link = f'<a href="{url}" target="_blank">Link</a>'  # Only "Link" is visible
# #         top_results.append({
# #             "Assessment #": idx,
